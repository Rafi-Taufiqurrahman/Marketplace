          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li>
                  @auth
                    @role('admin')
                        <a href="{{ route('admin.dashboard') }}"><i class="icon fa fa-user"></i>User Profile</a>
                    @else
              ...
              <ul class="dropdown-menu">
                <li>
                  <div class="cart-item product-summary">
                    <div class="row">
                      <div class="col-xs-4">
                        <div class="image"> <a href="detail.html"><img src="{{ asset('frontend/assets/images/logo.png') }}" alt=""></a> </div>
                      </div>
                      <div class="col-xs-7">
